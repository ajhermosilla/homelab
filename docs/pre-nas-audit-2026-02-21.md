...
- [x] **Headscale pre-assignment** — Headscale uses random allocation; IP pre-assignment not supported. Placeholder `100.64.0.12` has been replaced with actual IP `100.82.77.97` across all repo files.
