...
├── RPi 5: Headscale (PRIMARY), AdGuard Home
...
[VPS - Helper Only]
└── Vultr US: DERP relay, Uptime Kuma, ntfy, changedetection
```
...
- `docs/vps-architecture.md` (new)
- `docs/fixed-homelab.md` (new)
