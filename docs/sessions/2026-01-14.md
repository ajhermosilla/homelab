...
### Part 3: Domain & Branding Research
...
#### Why nanduti.io
- Ñanduti is traditional Paraguayan lace with web patterns
- Perfect metaphor for mesh networking
- Cultural flex + geek cred
- .io = hacker's TLD
...
| Homelab Domain | nanduti.io | Guarani "web", mesh metaphor |
| Business Domain | verava.net | Professional, easy to spell |
...
| Docs updated | 5 |
| Commits | 18 |
| Domains to buy | 2 (nanduti.io, verava.net) |
| Gaps identified | 15 (4 critical) |
| Improvement tasks | 17 |

## Next Steps

### Critical Fixes (Before Deployment)
- [ ] Increase Headscale backup to hourly
- [ ] Create disaster recovery runbook
- [ ] Add MQTT broker to services
- [ ] Document Caddy reverse proxy config
...
- [ ] Create docker-compose files (mobile kit first)
- [ ] Create Ansible playbooks
- [ ] Version control all configs

### Domains
- [ ] Purchase nanduti.io (Cloudflare ~$30/yr)
- [ ] Purchase verava.net (Cloudflare ~$12/yr)
